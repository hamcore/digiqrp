...
return [
    ...
    */
    'relations' => [
        ...
        'translations' => function (): \Illuminate\Database\Eloquent\Relations\BelongsTo {
            return $this->belongsTo(\Modules\Page\Entities\PageTranslation::class, 'id', 'page_id')->first();
        },
